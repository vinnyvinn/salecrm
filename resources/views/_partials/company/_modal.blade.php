<div class="modal fade" id="default-Modal-co" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{route('contact-person.store')}}">
                <div class="modal-body">
                        ...
                        <div class="form-row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($company->contactPerson)
                                    @if(!$company->contactPerson->where('primary_contact','Yes')->first())
                                    <option>Yes</option>
                                    @endif
                                @else
                                    <option>Yes</option>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="description" id="description" class="form-control" cols="30" rows="5" required>{{  old('description') }}</textarea>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-warning btn-xs waves-effect waves-light "> Add</button>
                </div>
            </form>
        </div>
    </div>
