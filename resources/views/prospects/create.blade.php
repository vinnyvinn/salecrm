			...
			<div class="page-wrapper">
				<div class="page-body">
					<div class="row">
						...
						<div class="col-md-8">
							<form action="{{ route('prospects.store', $lead->id) }}" method="post">
								<div class="card">
									<div class="card-header">
									...
									<div class="card-block">
										...
										<div class="form-group form-row">
											...
											<select name="company" id="company" class="form-control" >
												<option value="{{$lead->company?$lead->company->id:''}}">{{$lead->company?$lead->company->name:'Select Company'}}</option>
											...
											<div class="col-md-6">
												...
												<input class="form-control" min="0" type="number" name="estimated_value" id="estimated_value" value="{{ old('estimated_value') }}" required>
										...
										<div class="form-group form-row">
											<div class="col-md-6">
												...
												<input name="deadline" type="text" class="form-control datepicker" value="{{ old('deadline') }}" required readonly placeholder="Deadline">
											...
											<select name="assigned_to" id="assigned_to" class="form-control" required>
												<option value="{{$lead->assignee ? $lead->assignee->id : ''}}">{{$lead->assignee ? $lead->assignee->name : 'Select Assignee'}}</option>
												@foreach ($system_users as $user)
													<option value="{{ $user->id }}" {{ old('assigned_to') == $user->id || $lead->assignee_id == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
												@endforeach
											</select>
