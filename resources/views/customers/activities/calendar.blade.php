            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-review_type">
                        <h4 class="m-b-10">{{ $customer->name }} calendar</h4>
                    </div>
                    <ul class="breadcrumb float-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('customer.show', $customer->id)}}"> {{ $customer->name}}</a></li>
...
@section('js')
	...
	<script type="text/javascript">
        var events = [];
        $.ajax({
            'url': '{{ url('customers/activities/event?customer_id='. $customer->id) }}',
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-12">
                            <div class="form-group form-row">
                                ...
                                <input type="hidden" id="related" name="related" value="{{ $customer->id }}">
                                <input type="hidden" id="associate" name="associate" value="customer">
                            </div>
                        </div>
                    </div>
